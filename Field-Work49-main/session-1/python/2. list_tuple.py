...
print("Accessing Matrix: ", matrix[1][2])
...
mixed_tuple = ("Rajorshe", 24, "Chittagong", "problem-solving ")

person_dict = {
    "name": mixed_tuple[0],
    "age": mixed_tuple[1],
    "location": mixed_tuple[2],
    "skills": mixed_tuple[3]
}
